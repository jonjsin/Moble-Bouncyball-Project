...
namespace BouncyBall
{
    ...
    {
        public static bool Stage6_clear = false;
        int starcnt = 0;
        ...
        private void Reset()
        {
            ...
            if (One_HighJump.Visible == false) { One_HighJump.Visible = true; }
        }
        private void PJOStage2_Load(object sender, EventArgs e)
        {
            start_X = Ball.Location.X;
            start_Y = Ball.Location.Y;
            picturelist.Add(hid1);
            picturelist.Add(hid2);
        }
        ...
        private void PJOStage2_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Left:
        ...
        private void PJOStage2_KeyUp(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Left:
        ...
        private void Stage6_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            foreach (Control control in this.Controls)
            {
                ...
                {
                    if (flag_jump == false && Ball.Bounds.IntersectsWith(control.Bounds) && control.Name != Ball.Name && control.Name != Star1.Name && control.Name != Star2.Name && control.Name != Star3.Name)
                    {
                        ...
                        else if ((control.Name == One_HighJump.Name))
                        {
                        ...
                        else if (control.Name == RightStraight.Name)
                        {
                        ...
                        else if (control.Name == hid1.Name || control.Name == hid2.Name)
                        {
                            if (control.Visible == true)
                            {
                                control.Visible = false;
